	...
	<x-app-layout>
	    <x-slot name="header">
	        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
	        	<a href="{{ route('artists') }}">Manage artists </a>- Edit artist
	        </h2>
	    </x-slot>
	            ...
	            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
			        <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
					    <div class="px-6 py-4 text-2xl">
					    	<div class="font-bold text-lg mb-2">Edit artist information</div>
					    </div>
						...
						@csrf
							...
							<div class="flex flex-col mb-4">
								...
								<a href="https://www.google.com/search?q={{$name}}&tbm=isch" target="_blank"><button wire:click="search" class="border block rounded text-lg mx-auto p-4" type="button">Search google</button></a>

								<div x-data="{ open: false}">
									<button wire:model="btnState" wire:click="btnState" type="button" @click="open = true" class="border block rounded text-lg mx-auto p-4">{{$btnState}}</button>
							...
							<button class="bg-teal-100 border block hover:bg-teal-dark text-black uppercase text-lg mx-auto p-4 rounded" type="submit">Update</button>
					    </form>
					</div>
			    </div>
			</div>
